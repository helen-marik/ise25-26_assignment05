Feature: Points of Sale Management
  ...
  Scenario: Update one of three existing POS
    ...
    When I insert POS with the following elements
      ...
      | New Vending Machine    | Use only in case of emergencies  | VENDING_MACHINE | BERGHEIM  | Teststraße      | 99a          | 12345      | Other City |
    Then the POS list should contain the same elements in the same order
    When I update the existing POS with the name "Bäcker Görtz" with the description "Great Sandwiches"
    Then the description of the POS with the name "Bäcker Görtz" is updated to "Great Sandwiches"
